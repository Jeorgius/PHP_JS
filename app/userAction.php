...
class userAction
{
    ...
    public function CreateUser($nickname='', $jsonData_S, $jsonData_F, $jsonData_Short) {
        ...
        $jsonDataSecure = json_decode($jsonData_S);
        $jsonDataSecure->id = $id;
        $jsonContentSecure = $jsonDataSecure;

        $jsonDataFree = json_decode($jsonData_F);
        $jsonDataFree->id = $id;
        $jsonContentFree = $jsonDataFree;

        $jsonShort = json_decode($jsonData_Short); // JSON string decode makes it stdClass
        $jsonShort->id = $id;
        $jsonContentShort = $jsonShort;
